...
- Προσθήκη συναλλαγής ως έσοδο ή έξοδο με ποσό, κατηγορία, σημείωση, ημερομηνία και επιλογή μηνιαίας επανάληψης.
- Ιστορικό συναλλαγών με αναζήτηση, φίλτρα τύπου/κατηγορίας/μηνιαίων συναλλαγών, ένδειξη μηνιαίων συναλλαγών και δυνατότητα επεξεργασίας/διαγραφής.
